# Package marker for the realestate_agent package.
#
...
# `graph.py` via the `./realestate_agent/graph.py:graph` entry in
# `agent/langgraph.json` — package machinery stays intact, so `from
# .tools import ...` inside graph.py works without sys.path hacks.
